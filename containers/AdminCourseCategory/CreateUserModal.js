...
const Modal = ({ show, modalTitle, onClose, onSubmit, dataUser, isUpdate }) => {
    ...
    const validateData = () => {
        ...
        if (!thumbnail && !thumbnailFile) error.thumbnail = '* Bat buoc';
        if(thumbnailFile?.size > 1024* 1024) error.thumbnail = 'The largest image is 1MB';
                        ...
                        <form className="row">
                            ...
                            <div className="col-md-6 d-flex align-items-center justify-content-start">
                                <div className="form-check form-switch form-check-md">
                                    <input className="form-check-input" type="checkbox" id="checkPrivacy1" checked={isActived} onChange={(e) => setActived(!isActived)}/>

            ...
            <div className="row align-items-center g-5">
                ...
                <svg width="300px" height="62.1px" enable-background="new 0 0 366 62.1" viewBox="0 0 366 62.1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <a href="https://eduport.webestica.com/#" className="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">Get Started</a>
                    
            <a  data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" className="ms-0 ms-sm-4 d-block">
                ...
                <div className="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <div className="p-2 bg-white shadow rounded-3 position-absolute top-50 start-0 translate-middle-y mt-n7 d-none d-sm-block">
                        <img src="/Eduport - LMS, Education and Course Theme_files/science.svg" alt="Icon"/>
                    </div>
                    <div className="p-2 bg-white shadow rounded-3 position-absolute top-0 end-0 me-5">
                        <img src="/Eduport - LMS, Education and Course Theme_files/angular.svg" alt="Icon"/>
                    </div>
                    <div className="p-2 bg-white shadow rounded-3 position-absolute top-50 end-0 translate-middle-y mt-5 ms-5 d-none d-lg-block z-index-9">
                        <img src="/Eduport - LMS, Education and Course Theme_files/figma.svg" alt="Icon"/>
                    </div>
                    ...
                    <div className="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-5">
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <div className="text-start ms-3">
                                <h6 className="mb-0 text-white">Congratulations <span className="ms-4"><i className="fas fa-check-circle text-success"></i></span></h6>
                    ...
                    <div className="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style={{backgroundImage: 'url(/assets/images/pattern/01.png) no-repeat center center', backgroundSiz :'cover' }}>
                        <p className="text-white">Our daily new students</p>
                        
                        <ul className="avatar-group mb-0">
                            <li className="avatar avatar-sm">
                                <img className="avatar-img rounded-circle border-white" src="/Eduport - LMS, Education and Course Theme_files/01.jpg" alt="avatar"/>
                            </li>
                            <li className="avatar avatar-sm">
                                <img className="avatar-img rounded-circle border-white" src="/Eduport - LMS, Education and Course Theme_files/02.jpg" alt="avatar"/>
                            </li>
                            <li className="avatar avatar-sm">
                                <img className="avatar-img rounded-circle border-white" src="/Eduport - LMS, Education and Course Theme_files/03.jpg" alt="avatar"/>
                            </li>
                            <li className="avatar avatar-sm">
                                <img className="avatar-img rounded-circle border-white" src="/Eduport - LMS, Education and Course Theme_files/04.jpg" alt="avatar"/>
                            </li>
                            <li className="avatar avatar-sm">
                    ...
                    <div className="position-relative">
                        <img src="/Eduport - LMS, Education and Course Theme_files/07.png" alt=""/>
                    </div>
                </div>
	...
	<div className="container">
		...
		<div className="row g-4">			
				...
				<div className="card card-metro overflow-hidden rounded-3">
					...
					<div className="card-img-overlay d-flex"> 
						...
						<div className="mt-auto card-text">
							<a href="#" className="text-white mt-auto h5 stretched-link">Digital Marketing</a>
							<div className="text-white">23 Courses</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="col-sm-6 col-lg-4 col-xl-3">
				...
				<div className="card card-metro overflow-hidden rounded-3">
					...
					<div className="card-img-overlay d-flex"> 
						...
						<div className="mt-auto card-text">
							<a href="#" className="text-white mt-auto h5 stretched-link">Figma</a>
			...
			<div className="col-sm-6 col-lg-4 col-xl-3">
				...
				<div className="card card-metro overflow-hidden rounded-3">
					<img src="/assets/images/05.jpeg" alt=""/>
				
					<div className="card-img-overlay d-flex"> 
					
						<div className="mt-auto card-text">
							<a href="#" className="text-white mt-auto h5 stretched-link">Python</a>
			...
			<div className="col-sm-6 col-lg-4 col-xl-3">
				...
				<div className="card card-metro overflow-hidden rounded-3">
					<img src="/assets/images/06.jpeg" alt=""/>
				
					<div className="card-img-overlay d-flex"> 
					
						<div className="mt-auto card-text">
							<a href="#" className="text-white mt-auto h5 stretched-link">Angular</a>
			...
			<div className="col-sm-6 col-lg-4 col-xl-3">
				...
				<div className="card card-metro overflow-hidden rounded-3">
					<img src="/assets/images/07.jpeg" alt=""/>
				
					<div className="card-img-overlay d-flex"> 
					
						<div className="mt-auto card-text">
						
                            <Link href={`/course-category/react-native`}>
                                <a className="text-white mt-auto h5 stretched-link">React-Native</a>
			...
			<div className="col-sm-6 col-lg-4 col-xl-3">
				...
				<div className="card card-metro overflow-hidden rounded-3">
					<img src="/assets/images/08.jpeg" alt=""/>
					
					<div className="card-img-overlay d-flex"> 
					
						<div className="mt-auto card-text">
							<a href="#" className="text-white mt-auto h5 stretched-link">Sketch</a>
			...
			<div className="col-sm-6 col-lg-4 col-xl-3">
				...
				<div className="card card-metro overflow-hidden rounded-3">
					<img src="/assets/images/09.jpeg" alt=""/>
				
					<div className="card-img-overlay d-flex"> 
					
						<div className="mt-auto card-text">
							<a href="#" className="text-white mt-auto h5 stretched-link">Javascript</a>
			...
			<div className="col-sm-6 col-lg-4 col-xl-3">
				...
				<div className="card card-metro overflow-hidden rounded-3">
					...
					<div className="card-img-overlay d-flex"> 
						...
						<div className="mt-auto card-text">
							<a href="#" className="text-white mt-auto h5 stretched-link">Bootstrap</a>
